-- 015_lessons_video_field_fixed.sql
...
-- Удаляем старую версию функции (с предыдущими параметрами)
...
-- Создаём новую версию функции с поддержкой video_path
